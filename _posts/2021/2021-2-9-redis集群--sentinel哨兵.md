...
![image.png](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1595224812819-af458051-28cc-41f9-a8b0-54aadad0ed39.png)

整体架构：

- 当前采用主从机构+哨兵（sentinel），实现redis容灾的自动切换

  ![](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/sentinel.jpeg)
...
![](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596518761606.png)

- 192.168.3.190:6379 （slave）（当master_link_status 为 down 时，检查端口是否开启）

![](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596518870312.png)
...
![1596519195543](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596519195543.png)

  - 从机（slave）

![1596519250568](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596519250568.png)
...
![1596521549910](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596521549910.png)
...
- 将master主机重启查看从机是否会切换到主机模式，实现主从切换。
  ...
  - 重启master（192.168.3.189）后redis状态，当前显示192.168.3.191 从机服务器切换成为主机
    ...
    ![1596521966337](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596521966337.png)

  - 查看（192.168.3.191）服务器，此时从机切换成主机（master）

    ![1596522090356](http://taoey.github.io/assets/images/artcles/2021-2-9-redis集群--sentinel哨兵.assets/1596522090356.png)