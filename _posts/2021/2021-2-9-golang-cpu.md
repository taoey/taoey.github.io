...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCJ6)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCJ8)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCKd)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCKf)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCKj)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCKn)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCKL)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCKX)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCK1)



假设线程1首先读取数据A，因为按缓存行读取，且A和B在物理内存上是相邻的，所以数据B也会被加载到Core 1的缓存行中，此时将此缓存行标记为**Exclusive**状态。

![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCK5)



接着线程2读取数据B，它从内存中取出了数据A和数据B到缓存行中。由于在Core 1中已经存在当前数据的缓存行，那么此时处理器会将这两个缓存行标记为**Shared**状态。

![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCK7)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCLf)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-9-golang-cpu.assets/bVcNCLn)
