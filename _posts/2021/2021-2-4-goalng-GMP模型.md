...
我们知道，一切的软件都是跑在操作系统上，真正用来干活(计算)的是CPU。早期的操作系统每个程序就是一个进程，知道一个程序运行完，才能进行下一个进程，就是“单进程时代”我们知道，一切的软件都是跑在操作系统上，真正用来干活(计算)的是CPU。早期的操作系统每个程序就是一个进程，知道一个程序运行完，才能进行下一个进程，就是“单进程时代”，
 ...
 一切的程序只能串行发生。
   ...
   ![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018402)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018403)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018400)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640)



这样，我们再去细化去分类一下，内核线程依然叫“线程(thread)”，用户线程叫“协程(co-routine)".

![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018108)
...
缺点:：某个程序用不了硬件的多核加速能力，![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640)**一旦某协程阻塞**，造成线程阻塞，本进程的其他协程都无法执行了，无并发能力





![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018406)
...
​    Go目前使用的调度器是2012年重新设计的，因为之前的调度器性能存在问题，所以使用4年就被废弃了，那么我们先来分析一下被废弃的调度器是如何运作的？![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018108)
...
![image.gif](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/image.gif)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018407)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018415)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018401)

![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018681)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018439)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018404)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018405)

​    G1运行完成后(函数：`goexit`)，M上运行的goroutine切换为G0，G0负责调度时协程的切换（函数：`schedule`）。从P的本地队列取G2，从G0切换到G2，并开始运行G2(函数：`execute`)。实现了线程M1的复用。

![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018447)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018438)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018440)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018490)

![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018450)
...
![image](http://beangogo.cn/assets/images/artcles/2021-2-4-goalng-GMP模型.assets/640-1612425018441)
